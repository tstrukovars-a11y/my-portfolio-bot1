...
CALL_CARD = (
    "📞 <b>Помощь со звонком на чужом языке</b>\n\n"
    "Клиника, банк, хозяин квартиры, служба доставки — иврит, английский "
    "или французский.\n\n"
    "Страница показывает, <b>какую цифру нажать</b>, когда автоответчик "
    "диктует меню, и <b>говорит за вас</b> нужные фразы вслух, в трубку. "
    "Произносить самому ничего не нужно.\n\n"
    "<b>Нужны два устройства:</b>\n"
    "1. С телефона звоните и включаете громкую связь.\n"
    "2. Рядом — компьютер с открытой страницей, динамиком к нему.\n\n"
    "На одном телефоне не выйдет: во время звонка микрофон занят самим "
    "звонком, и браузеру он уже не достанется.\n\n"
    "Бесплатно, ставить ничего не надо, разговор не сохраняется.\n\n"
    "{url}\n\n"
...
@router.callback_query(F.data == "lang_call")
async def call_button(call: CallbackQuery):
    await call.answer()
    await call_command(call.message)
